          ...
          <div className="contact-content">
            ...
            <div className="contact-info">
              ...
              <div className="contact-item">
                <span style={{ fontSize: '1.5rem', color: '#d4a017' }}>📞</span>
                <div>
                  <h4>Call Us</h4>
                  <a href="tel:2032333862" style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>
                    203.233.3862
                  </a>
              ...
              <div className="contact-item">
                <span style={{ fontSize: '1.5rem', color: '#d4a017' }}>✉️</span>
                <div>
                  <h4>Email Us</h4>
              ...
              <div style={{ marginTop: '2rem', paddingTop: '2rem', borderTop: '2px solid #e5e7eb' }}>
                <h4 style={{ marginBottom: '1rem' }}>Service Areas</h4>
